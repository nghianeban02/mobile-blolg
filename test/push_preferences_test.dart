...
void main() {
  test('PushPreferencesDto parse payload từ be-blog, thiếu field mặc định bật', () {
  ...
  test('toJson tròn vòng đủ 6 loại — khớp contract PUT /api/notifications/preferences', () {
    ...
    expect(json.keys, containsAll(['messages', 'calls', 'friends', 'comments', 'likes', 'system']));
